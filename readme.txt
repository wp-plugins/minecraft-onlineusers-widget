...
Le plugin **Minecraft Online Players Widget** est un plugin permettant d'afficher les joueurs en ligne d'un serveur Minecraft dans le menu du blog grâce à la fonction "query" de CraftBukkit.Soutenez le créateur de cette extension en vous abonnant à sa chaîne : <a href="http://www.youtube.com/user/PirmaxLePoulpeRouge" target="_blank">PirmaxLePoulpeRouge</a>.
...
Rendez-vous dans le pannel des widgets sur votre blog Wordpress, et ajoutez le widget <code>Minecraft Online Players</code>, configurez ensuite l'ip et le port du serveur ainsi que le nombre de slot de votre serveur, puis cliquez sur <code>Enregistrer</code>.

== Screenshots ==

1. Exemple d'affichage de plusieurs joueurs en ligne
2. Exemple d'affichage de deux joueurs en ligne
